namespace Cell.Runtime {
  public sealed class IntColumnUpdater {
    ...
    internal long Lookup(int surr1) {
    ...
    private KeyViolationException Col1KeyViolation(int idx, long value, bool betweenNew) {
      if (betweenNew) {
        for (int i=0 ; i < updateCount ; i++)
          if (updateIdxs[i] == idx)
